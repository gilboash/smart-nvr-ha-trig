      ...
      <div class="card">
        ...
        <form id="edit-form">
          ...
          <div class="row">
            ...
            <div><label>Record continuously</label>
              <label style="display:inline-flex;align-items:center;gap:0.4rem;margin-top:0.3rem">
                <input type="checkbox" name="record_enabled" ${camera.record_enabled ? 'checked' : ''}>
                <span style="font-size:0.85rem;color:var(--muted)">DVR rolling window</span>
              </label>
            </div>
            <div><label>Recording FPS</label><input name="record_fps" type="number" step="0.1" min="0.1" max="5" value="${camera.record_fps}" title="Frames per second written to the DVR recording (0.1–5)"></div>
